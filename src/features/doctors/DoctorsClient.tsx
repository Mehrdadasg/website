...
export default function DoctorsClient({ expertPageData, expertCategories, expertList }: DoctorsClientProps) {
  ...
  const doctorsList = useMemo(() => {
    return selectedCategoryId === 0
      ? expertList
      : expertList?.filter(
          (doctor: ExpertType) => doctor.CategoryId === selectedCategoryId
        ) || [];
  }, [expertList, selectedCategoryId]);
